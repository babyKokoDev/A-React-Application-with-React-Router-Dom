        ...
        <div className="container">
            <div className="content">
                <div className="col-1">
                    ...
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. A quia fugiat neque vel tenetur aliquam velit excepturi suscipit dicta similique!</p>
                ...
                <div className="col-2">
                    <div className="form-layout">
                        ...
                        <div className="form-footer">
                            ...
                            <span className='primary-color'> Cookies Policy</span></p>
                        </div>
                    </div>
                </div>
            </div>
